...
class SalObjDataset(Dataset):
	...
	def __getitem__(self,idx):
		...
		if(0==len(self.label_name_list)):
			...
			# label_3 = io.imread(self.label_name_list[idx], plugin='matplotlib')
			label_3 = io.imread(self.label_name_list[idx])
			# label_3 = np.array(Image.open(self.label_name_list[idx]))
			# label_3 = label_3 * 255
			# print(np.unique(label_3), np.array(label_3).shape)
