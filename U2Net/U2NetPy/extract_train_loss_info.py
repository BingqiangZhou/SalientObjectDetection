...
def extract_content_from_txt_file(txt_file_path):
...
def extract_content_from_model_names(file_dir, gap=2000):
...
# txt_file_path = "./nohup.out"
# extract_content_from_txt_file(txt_file_path)

file_dir = "./saved_models/u2net/"
extract_content_from_model_names(file_dir)